        ...
        <div class="px-4 py-6 sm:px-0">
            <div class="bg-red-500 p-6 rounded-lg">
                <div class="flex items-center justify-center space-x-4">
                    <img src="{{ asset('images/homeuser1.jpeg') }}" alt="Placeholder Image" class="rounded-lg shadow-lg w-1/2">
                    <img src="{{ asset('images/homeuser2.jpg') }}" alt="Placeholder Image" class="rounded-lg shadow-lg w-1/2">
                </div>
            </div>
